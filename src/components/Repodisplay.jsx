...
const Repodisplay = () => {
  ...
  return (
    <section className="bg-[#F5F5F5] flex  justify-center  items-center max-sm:py-4 ">
      <div className="bg-white w-[70%] h-[75vh] bg-blue rounded shadow-md  max-sm:h-[100vh]">
        <div className="px-5 py-3">
          <h3 className="text-[#002147] font-defaultfont font-bold">{name}</h3>
          <div className="flex  gap-2 py-5"></div>
        </div>

        <div className="grid grid-cols-3 gap-6 px-5 py-3 text-center max-sm:flex max-sm:flex-col ">
        ...
        <div className="grid grid-cols-3 gap-6 px-5 py-5  text-center  max-sm:flex max-sm:flex-col">
        ...
        <div className="grid grid-cols-3 gap-6 px-5 py-5 text-center max-sm:flex max-sm:flex-col">
          ...
          <div className="ring-1  px-7 py-7 max-sm:py-5">Open Issues : 0</div>
          <div className="ring-1 px-7 py-7 max-sm:py-5">
